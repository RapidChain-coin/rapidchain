...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The RapidChain Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "RapidChain Core"
...
#define PACKAGE_NAME "RapidChain Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Bitcoin Core 0.19.99"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "rapidchain"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://rapid-chain.com/"
