...
class PSBTTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # Create and fund a raw tx for sending 10 RPC
        ...
        # feeRate of 0.1 RPC / KB produces a total fee slightly below -maxtxfee (~0.05280000):
        ...
        # feeRate of 10 RPC / KB produces a total fee well above -maxtxfee
