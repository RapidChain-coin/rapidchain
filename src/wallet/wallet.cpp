...
int CWalletTx::GetBlocksToMaturity() const
{
    ...
    //RPCTODO Some wallets are still not abandoning coinstakes correctly
...
void CWallet::StakeRPCs(bool fStake, CConnman* connman, CTxMemPool* mempool)
{
    ::StakeRPCs(fStake, this, connman, mempool, stakeThread);
}

void CWallet::StartStake(CConnman *connman, CTxMemPool* mempool)
{
    m_enabled_staking = true;
    StakeRPCs(true, connman, mempool);
}
