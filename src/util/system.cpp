...
const char * const BITCOIN_CONF_FILENAME = "rapidchain.conf";
...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\RapidChain
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\RapidChain
    // Mac: ~/Library/Application Support/RapidChain
    // Unix: ~/.rapidchain
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "RapidChain";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/RapidChain";
#else
    // Unix
    return pathRet / ".rapidchain";
#endif
#endif
}
