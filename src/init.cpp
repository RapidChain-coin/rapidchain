 ...
 */
static const char* BITCOIN_PID_FILENAME = "rapidchaind.pid";
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/rapidchaincoin/rapidchain>";

    return (strprintf(_("Copyright (C) %i The RapidChain Core Developers").translated, COPYRIGHT_YEAR) + " ") +
           "\n" +
